  ...
  <div v-if="visible" class="image-viewer-overlay">
    <div class="image-viewer-container">
      ...
      <div class="image-viewer-content">
        <img :src="getImageSrc()" :alt="imageAlt" class="artwork-image" />
...
export default {
  ...
  methods: {
    getImageSrc() {
      // Get the proper image path from the resource manager
      if (this.imageSrc && this.rpgResource) {
        return this.rpgResource.get(this.imageSrc)
      }
